...
@notificationRouter.get("/mapService/notification/{user_id}")
...
@notificationRouter.delete("/mapService/notification/{notification_id}")
...
@notificationRouter.put("/mapService/read_notification/{notification_id}")
...
@notificationRouter.get("/mapService/read_notifications/")
